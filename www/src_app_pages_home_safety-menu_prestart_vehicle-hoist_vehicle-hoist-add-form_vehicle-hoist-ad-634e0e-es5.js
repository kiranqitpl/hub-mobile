      ...
      var _VehicleHoistAddFormPage = /*#__PURE__*/function () {
        ...
        _createClass(VehicleHoistAddFormPage, [{
          ...
          value: function onValueChange(event, type) {
            ...
            var data = 0.37 / Object.keys(this.vehicleHoistForm.controls).length * 100;
            console.log('data', data);
            this.form_percent = data + this.form_percent;
            console.log('this.form_percent', this.form_percent); // this.content.scrollToBottom(500);
