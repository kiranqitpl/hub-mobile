  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_home_safety-menu_prestart_vehicle-hoist_vehicle-hoist-add-form_vehicle-hoist-ad-634e0e"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _VehicleHoistAddFormPage = /*#__PURE__*/function () {
        function VehicleHoistAddFormPage(loadingService, toastService, navCtrl, fb, globalService, elementRef, alertService) {
        ...
        _createClass(VehicleHoistAddFormPage, [{
          ...
          value: function onProgressBar(event) {
            ...
            formControlList.forEach(function (key) {
              if (_this2.vehicleHoistForm.value[key] && _this2.vehicleHoistForm.value[key] != '' && _this2.vehicleHoistForm.value[key] == 'OK') {
                count = count + 2;
              } else if (_this2.vehicleHoistForm.value[key] && _this2.vehicleHoistForm.value[key] != '' && _this2.vehicleHoistForm.value[key] != 'OK') {
                count = ++count;
              }
            });
      ...
      _VehicleHoistAddFormPage = (0, tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
