(function () {
  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_home_safety-menu_incident_incident-form_incident-form_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_loading_service_loading_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
        ...
        _createClass(IncidentFormPage, [{
          ...
          value: function onProgressBar(event, tabName) {
            ...
            if (this.incidentForm.value['incident_value'] && this.incidentForm.value['incident_value'] != '') {
              ...
              Object.keys(this.incidentDesForm.value.incdesc_other_witness_details).map(function (ele) {
                return formControlList.push(ele);
              });

              if (this.classificationForm.valid) {
                Object.keys(this.classificationForm.controls).map(function (ele) {
                  return formControlList.push(ele);
                });
              }

              console.log(this.classificationForm.value); // Object.keys(this.injuryForm.controls).map(ele => formControlList.push(ele));
            ...
            formControlList.forEach(function (key) {
              if (tabName == 'Incident') {
                if (_this24.incidentForm.value[key] && _this24.incidentForm.value[key] != '' && _this24.incidentForm.value[key] != 'Near Miss') {
                  count = count + 2;
                } else if (_this24.incidentForm.value[key] && _this24.incidentForm.value[key] != '' && _this24.incidentForm.value[key] == 'Near Miss') {
                  count = ++count;
                }
              }
            });
      ...
      _IncidentFormPage = (0, tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_14__.Component)({
