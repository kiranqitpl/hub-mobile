      ...
      var _IncidentFormPage = /*#__PURE__*/function () {
        ...
        _createClass(IncidentFormPage, [{
          ...
          value: function onProgressBar(event, tabName) {
            ...
            Object.keys(this.injuryForm.controls).map(function (ele) {
              return formControlList.push(ele);
            }); // Object.keys(this.injuryForm.value.person_details).map(ele => formControlList.push(ele));

            Object.keys(this.assetDescriptionForm.controls).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.enviornmentForm.controls).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.enviornmentForm.value.chemical_details).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.reputationDesForm.controls).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.reputationDesForm.value.other_witness_details).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.reportForm.controls).map(function (ele) {
              return formControlList.push(ele);
            });
            Object.keys(this.securityForm.controls).map(function (ele) {
              return formControlList.push(ele);
            });
            console.log('formControlList', formControlList); // if (this.incidentForm.value['incident_value'] && this.incidentForm.value['incident_value'] != '') {
