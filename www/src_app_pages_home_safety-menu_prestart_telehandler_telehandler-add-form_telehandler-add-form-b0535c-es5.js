        ...
        _createClass(TelehandlerAddFormPage, [{
                    ...
                    case 0:
                      ...
                      this.camera.getPicture(options).then(function (imageData) {
                        ...
                        if (rowName == 'data_plate_image') {
                          _this2.teleHandlerForm.controls['data_plate_image'].setValue(image);
                        } else if (rowName == 'engine_oil_image') {
                          _this2.teleHandlerForm.controls['engine_oil_image'].setValue(image);
                        } else if (rowName == 'hydraulic_oil_image') {
                          _this2.teleHandlerForm.controls['hydraulic_oil_image'].setValue(image);
                        } else if (rowName == 'equipment_inspect_image') {
                          _this2.teleHandlerForm.controls['equipment_inspect_image'].setValue(image);
                        } else if (rowName == 'coolant_level_image') {
                          _this2.teleHandlerForm.controls['coolant_level_image'].setValue(image);
                        } else if (rowName == 'belts_and_hoses_image') {
                          _this2.teleHandlerForm.controls['belts_and_hoses_image'].setValue(image);
                        } else if (rowName == 'wheels_tyres_image') {
                          _this2.teleHandlerForm.controls['wheels_tyres_image'].setValue(image);
                        } else if (rowName == 'fire_extinguisher_image') {
                          _this2.teleHandlerForm.controls['fire_extinguisher_image'].setValue(image);
                        } else if (rowName == 'fuel_flash_image') {
                          _this2.teleHandlerForm.controls['fuel_flash_image'].setValue(image);
                        } else if (rowName == 'hydraulics_functional_image') {
                          _this2.teleHandlerForm.controls['hydraulics_functional_image'].setValue(image);
                        } else if (rowName == 'lift_arms_image') {
                          _this2.teleHandlerForm.controls['lift_arms_image'].setValue(image);
                        } else if (rowName == 'chain_hose_image') {
                          _this2.teleHandlerForm.controls['chain_hose_image'].setValue(image);
                        } else if (rowName == 'cap_bolts_image') {
                          _this2.teleHandlerForm.controls['cap_bolts_image'].setValue(image);
                        } else if (rowName == 'safety_stops_image') {
                          _this2.teleHandlerForm.controls['safety_stops_image'].setValue(image);
                        } else if (rowName == 'forks_image') {
                          _this2.teleHandlerForm.controls['forks_image'].setValue(image);
                        } else if (rowName == 'overhead_guards_image') {
                          _this2.teleHandlerForm.controls['overhead_guards_image'].setValue(image);
                        } else if (rowName == 'counterweight_image') {
                          _this2.teleHandlerForm.controls['counterweight_image'].setValue(image);
                        } else if (rowName == 'engine_bay_components_image') {
                          _this2.teleHandlerForm.controls['engine_bay_components_image'].setValue(image);
                        } else if (rowName == 'horn_image') {
                          _this2.teleHandlerForm.controls['horn_image'].setValue(image);
                        } else if (rowName == 'audible_image') {
                          _this2.teleHandlerForm.controls['audible_image'].setValue(image);
                        } else if (rowName == 'headlights_image') {
                          _this2.teleHandlerForm.controls['headlights_image'].setValue(image);
                        } else if (rowName == 'turn_signals_image') {
                          _this2.teleHandlerForm.controls['turn_signals_image'].setValue(image);
                        } else if (rowName == 'warning_brake_lights_image') {
                          _this2.teleHandlerForm.controls['warning_brake_lights_image'].setValue(image);
                        } else if (rowName == 'foot_brake_image') {
                          _this2.teleHandlerForm.controls['foot_brake_image'].setValue(image);
                        } else if (rowName == 'parking_brake_image') {
                          _this2.teleHandlerForm.controls['parking_brake_image'].setValue(image);
                        } else if (rowName == 'clutch_gear_shift_image') {
                          _this2.teleHandlerForm.controls['clutch_gear_shift_image'].setValue(image);
                        } else if (rowName == 'engine_noise_image') {
                          _this2.teleHandlerForm.controls['engine_noise_image'].setValue(image);
                        } else if (rowName == 'dash_gauges_image') {
                          _this2.teleHandlerForm.controls['dash_gauges_image'].setValue(image);
                        } else if (rowName == 'operational_controls_image') {
                          _this2.teleHandlerForm.controls['operational_controls_image'].setValue(image);
                        } else if (rowName == 'fluid_leaks_image') {
                          _this2.teleHandlerForm.controls['fluid_leaks_image'].setValue(image);
                        } else if (rowName == 'first_aid_kit_image') {
                          _this2.teleHandlerForm.controls['first_aid_kit_image'].setValue(image);
                        }
                      }, function (err) {
                    ...
                    case 0:
                      if (type == 1) {
                        ...
                        this.sharedService.getBase64(event.target.files[0]).then(function (image) {
                          if (rowName == 'data_plate_image') {
                            _this4.teleHandlerForm.controls['data_plate_image'].setValue(image); // if (this.teleHandlerForm.value['data_plate_image'].length <= 0) {
                            ...
                            _this4.teleHandlerForm.controls['engine_oil_image'].setValue(image);
                          } else if (rowName == 'hydraulic_oil_image') {
                            _this4.teleHandlerForm.controls['hydraulic_oil_image'].setValue(image);
                          } else if (rowName == 'equipment_inspect_image') {
                            _this4.teleHandlerForm.controls['equipment_inspect_image'].setValue(image);
                          } else if (rowName == 'coolant_level_image') {
                            _this4.teleHandlerForm.controls['coolant_level_image'].setValue(image);
                          } else if (rowName == 'belts_and_hoses_image') {
                            _this4.teleHandlerForm.controls['belts_and_hoses_image'].setValue(image);
                          } else if (rowName == 'wheels_tyres_image') {
                            _this4.teleHandlerForm.controls['wheels_tyres_image'].setValue(image);
                          } else if (rowName == 'fire_extinguisher_image') {
                            _this4.teleHandlerForm.controls['fire_extinguisher_image'].setValue(image);
                          } else if (rowName == 'fuel_flash_image') {
                            _this4.teleHandlerForm.controls['fuel_flash_image'].setValue(image);
                          } else if (rowName == 'hydraulics_functional_image') {
                            _this4.teleHandlerForm.controls['hydraulics_functional_image'].setValue(image);
                          } else if (rowName == 'lift_arms_image') {
                            _this4.teleHandlerForm.controls['lift_arms_image'].setValue(image);
                          } else if (rowName == 'chain_hose_image') {
                            _this4.teleHandlerForm.controls['chain_hose_image'].setValue(image);
                          } else if (rowName == 'cap_bolts_image') {
                            _this4.teleHandlerForm.controls['cap_bolts_image'].setValue(image);
                          } else if (rowName == 'safety_stops_image') {
                            _this4.teleHandlerForm.controls['safety_stops_image'].setValue(image);
                          } else if (rowName == 'forks_image') {
                            _this4.teleHandlerForm.controls['forks_image'].setValue(image);
                          } else if (rowName == 'overhead_guards_image') {
                            _this4.teleHandlerForm.controls['overhead_guards_image'].setValue(image);
                          } else if (rowName == 'counterweight_image') {
                            _this4.teleHandlerForm.controls['counterweight_image'].setValue(image);
                          } else if (rowName == 'engine_bay_components_image') {
                            _this4.teleHandlerForm.controls['engine_bay_components_image'].setValue(image);
                          } else if (rowName == 'horn_image') {
                            _this4.teleHandlerForm.controls['horn_image'].setValue(image);
                          } else if (rowName == 'audible_image') {
                            _this4.teleHandlerForm.controls['audible_image'].setValue(image);
                          } else if (rowName == 'headlights_image') {
                            _this4.teleHandlerForm.controls['headlights_image'].setValue(image);
                          } else if (rowName == 'turn_signals_image') {
                            _this4.teleHandlerForm.controls['turn_signals_image'].setValue(image);
                          } else if (rowName == 'warning_brake_lights_image') {
                            _this4.teleHandlerForm.controls['warning_brake_lights_image'].setValue(image);
                          } else if (rowName == 'foot_brake_image') {
                            _this4.teleHandlerForm.controls['foot_brake_image'].setValue(image);
                          } else if (rowName == 'parking_brake_image') {
                            _this4.teleHandlerForm.controls['parking_brake_image'].setValue(image);
                          } else if (rowName == 'clutch_gear_shift_image') {
                            _this4.teleHandlerForm.controls['clutch_gear_shift_image'].setValue(image);
                          } else if (rowName == 'engine_noise_image') {
                            _this4.teleHandlerForm.controls['engine_noise_image'].setValue(image);
                          } else if (rowName == 'dash_gauges_image') {
                            _this4.teleHandlerForm.controls['dash_gauges_image'].setValue(image);
                          } else if (rowName == 'operational_controls_image') {
                            _this4.teleHandlerForm.controls['operational_controls_image'].setValue(image);
                          } else if (rowName == 'fluid_leaks_image') {
                            _this4.teleHandlerForm.controls['fluid_leaks_image'].setValue(image);
                          } else if (rowName == 'first_aid_kit_image') {
                            _this4.teleHandlerForm.controls['first_aid_kit_image'].setValue(image);
                          }
          ...
          value: function onProgressBar(event) {
            ...
            formControlList.forEach(function (key) {
              if (_this6.teleHandlerForm.value[key] && _this6.teleHandlerForm.value[key] != '' && _this6.teleHandlerForm.value[key] == 'Ok') {
                count = count + 3;
              } else if (_this6.teleHandlerForm.value[key] && _this6.teleHandlerForm.value[key] != '' && _this6.teleHandlerForm.value[key] != 'Ok') {
                count = ++count;
              }
            });
          ...
          value: function loadData(id) {
            ...
            this.globalService.getData('add_form/getSingleData?table_name=telehandler&id=' + id).subscribe(function (result) {
              if (result && result['data'] && result['data'][0]) {
                _this7.telehandlerData = result['data'][0];

                _this7.teleHandlerForm.patchValue(_this7.telehandlerData);

                _this7.onProgressBar('');

                console.log('this.teleHandlerForm ', _this7.teleHandlerForm);
              }
            }), function (error) {
              console.log(error);
            };
                    ...
                    case 0:
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          text: 'Load from Library',
                          handler: function handler() {
                            return images = _this8.pickImage(_this8.camera.PictureSourceType.PHOTOLIBRARY);
                          }
                        }, {
                          text: 'Use Camera',
                          handler: function handler() {
                            return images = _this8.pickImage(_this8.camera.PictureSourceType.CAMERA);
                          }
                        }, {
                          text: 'Cancel',
                          role: 'cancel'
