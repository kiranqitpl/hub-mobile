    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _TelehandlerAddFormPage = /*#__PURE__*/function () {
        function TelehandlerAddFormPage(fb, globalService, toastService, nav, loadingService, modalController, sharedService, actionSheetController, camera, alertService, activatedRoute) {
          ...
          this.isSubmitted = false; // showMsg: boolean = false;
                    ...
                    case 0:
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          text: 'Load from Library',
                          handler: function handler() {
                            return images = _this6.pickImage(_this6.camera.PictureSourceType.PHOTOLIBRARY);
                          }
                        }, {
                          text: 'Use Camera',
                          handler: function handler() {
                            return images = _this6.pickImage(_this6.camera.PictureSourceType.CAMERA);
                          }
                        }, {
                          text: 'Cancel',
                          role: 'cancel'
