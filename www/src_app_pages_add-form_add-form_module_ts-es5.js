  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_add-form_add-form_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddFormPageRoutingModule": function AddFormPageRoutingModule() {
          return (
            /* binding */
            _AddFormPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _add_form_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-form.page */
      39625);
      ...
      var _AddFormPageRoutingModule = function AddFormPageRoutingModule() {
        _classCallCheck(this, AddFormPageRoutingModule);
      };

      _AddFormPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddFormPageModule": function AddFormPageModule() {
          return (
            /* binding */
            _AddFormPageModule
          );
      ...
      var _add_form_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./add-form-routing.module */
      93377);
      /* harmony import */


      var _add_form_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./add-form.page */
      39625);

      var _AddFormPageModule = function AddFormPageModule() {
        _classCallCheck(this, AddFormPageModule);
      };

      _AddFormPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _add_form_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddFormPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "AddFormPage": function AddFormPage() {
          return (
            /* binding */
            _AddFormPage
          );
      ...
      var _raw_loader_add_form_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./add-form.page.html */
      1609);
      /* harmony import */


      var _add_form_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./add-form.page.scss */
      52223);
      /* harmony import */
      ...
      var _AddFormPage = /*#__PURE__*/function () {
        function AddFormPage(nav, modal, camera, actionSheetController, file, global, base64, platform) {
          _classCallCheck(this, AddFormPage);
          ...
          this.platformCheck = ''; //added field
        ...
        _createClass(AddFormPage, [{
          ...
          value: function reputationCheckboxEvent(e, entry) {
            ...
            this.reputationCheckBox.forEach(function (element) {
              if (element.val === 'Individual') {
                _this.individualChecked = element.isChecked;
              } else if (element.val === 'Company') {
                _this.companyChecked = element.isChecked;
              }
            });
          }
        }, {
          ...
          value: function pickImage(sourceType, e) {
            ...
            this.camera.getPicture(options).then(function (imageData) {
              ...
              if (e == 1) {
                _this2.imagePath = image; // let t = this.DataURIToBlob(image);
                // let realData = this.imagePath.split(",")[1];

                _this2.imageUri = imageData;
              }

              if (e == 2) {
                _this2.imagePath2 = image;

                var t = _this2.DataURIToBlob(image);

                _this2.image2Uri = imageData;
              }

              if (e == 3) {
                _this2.imagePath3 = image;
                _this2.image3Uri = imageData;
              }

              if (e == 4) {
                _this2.imagePath4 = image;
                _this2.image4Uri = imageData;
              }

              if (e == 5) {
                _this2.imagePath5 = image;
                _this2.image5Uri = imageData;
              }

              if (e == 6) {
                _this2.drugImage = image;
                _this2.drugTestImageUri = imageData;
              }

              if (e == 7) {
                _this2.returnToDutiesImage = image;
              }
            }, function (err) {
          ...
          value: function saveItemOffline() {
            ...
            this.person_one_details.injurryCheckBox.forEach(function (element) {
              if (element.isChecked) {
                _this5.person_one_details.injury_value.push(element.val);
              }
            });
            ...
            this.person_two_details.injurryCheckBox.forEach(function (element) {
              if (element.isChecked) {
                _this5.person_two_details.injury_value.push(element.val);
              }
            });
            ...
            this.person_three_details.injurryCheckBox.forEach(function (element) {
              if (element.isChecked) {
                _this5.person_three_details.injury_value.push(element.val);
              }
            });
            ...
            this.person_four_details.injurryCheckBox.forEach(function (element) {
              if (element.isChecked) {
                _this5.person_four_details.injury_value.push(element.val);
              }
            });
            ...
            this.person_four_details.immediate_treatment_person_number = this.person_four_details.adminsteredPersonNumber; // let requiredData = {
            //   descriptionIncident: this.descriptionIncident,
            //   immediateAction: this.immediateAction,
            //   environmentActionTaken: this.environmentActionTaken,
            //   nameOfAnyWitness: this.nameOfAnyWitness,
            ...
            fd.append("reputation_negative_effect", this.nagativeEffetct); //incident photo pending from postman and here also 
            ...
            this.global.postData("api/Add_form/submit_incomplete", fd).subscribe(function (res) {
              ...
              if (res.status) {
                _this5.global.presentToast(res.message);

                _this5.global.dismissLoading();

                _this5.nav.navigateRoot("form-list");
              } else {
                _this5.global.presentToast(res.message);
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        ...
                        if ((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.full_name) {
                          _this6.nameOfManager = res.data.full_name;
                        }
                      });
                      _context2.next = 6;
          ...
          value: function onSubmit() {
            ...
            if (this.incedent === '') {
              ...
              fd.append("incident_near_miss", this.whoWitnessedNearThis);
              fd.append("incident_near_miss_other", this.possibleConsequence); //----------------------------------- Incident -----------------------------------// 
              //----------------------------------- photography -----------------------------------//

              fd.append("photography_image", this.imagePath); //----------------------------------- photography -----------------------------------//
              ...
              fd.append("was_there_any_witness_of_the_incident", this.wasThereAnyWitnessOfIncident);
              fd.append("return_to_alternate_duties", this.returnToAlternateDuties);
              fd.append("return_to_alternate_duties_image", this.returnToDutiesImage); //----------------------------------- Incident Description -----------------------------------//
              //----------------------------------- Classification -----------------------------------//
              ...
              fd.append("person_details", JSON.stringify(this.personDetails));
              fd.append("part_of_body_injured_occured", this.partOfBodyInjured); //-------------------------------------------Injury ----------------------------------//
              //-------------------------------------------Enviornment ----------------------------------//
              ...
              fd.append("chemical_details", JSON.stringify(this.checmicalDetails));
              fd.append("emergency_spill_kit_used", this.emergencySpill); //-------------------------------------------Enviornment ----------------------------------//
              //-------------------------------------------Reputation ----------------------------------//
              ...
              fd.append("reutation_negative_effect", this.nagativeEffetct); //-------------------------------------------Reputation ----------------------------------//
              //----------------------------------- Security-----------------------------------//
              ...
              fd.append("what_has_been_stolen_item", this.stolenItem);
              fd.append("approximate_value_of_stolen", this.approximateValueOfStolen);
              fd.append("what_is_the_specific_securities_incident", this.specificSecurityIncident); //----------------------------------- Security-----------------------------------//
              //-------------------------------------------Asset ----------------------------------//
              ...
              fd.append("extent_damage_image", this.imagePath5); //-------------------------------------------Asset ----------------------------------//
              //-------------------------------------------Report ----------------------------------//

              fd.append("report", this.doneDifferently); //-------------------------------------------Report ----------------------------------//
              // fd.append("contact_of_witness", this.contactOfAnyWitness);
          ...
          value: function onSelectFile(event, e) {
            ...
            if (event.target.files && event.target.files[0]) {
              ...
              reader.onload = function (event) {
                ...
                if (e == 6) {
                  _this8.drugImage = event.target.result;
                }
          ...
          value: function timeSelect(e, from) {
            if (from == 'timeIncident') {
              ...
              this.selectedTimeReported = e.detail.value; // this.timeReported = moment(e.detail.value).format("hh:mm A");
      ...
      _AddFormPage.ctorParameters = function () {
        return [{
      ...
      _AddFormPage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
...
//# sourceMappingURL=src_app_pages_add-form_add-form_module_ts-es5.js.map