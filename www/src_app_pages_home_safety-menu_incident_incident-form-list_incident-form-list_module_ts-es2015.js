...
IncidentFormListPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
let IncidentFormListPage = class IncidentFormListPage {
    ...
    loadData(pageNo) {
        ...
        this.global.getData('add_form/get/?page_no=' + this.current_page_no).subscribe((result) => {
