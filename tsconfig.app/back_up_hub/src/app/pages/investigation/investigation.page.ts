...
export class InvestigationPage implements OnInit {
  ...
  typeSelect(e) {
    ...
    if(this.isFrom=='add'){
      ...
      console.log("investigationLocalStorage", localDataStore)
      localStorage.setItem("investigationLocalStorage", JSON.stringify(localDataStore))
    }    
  }
  ...
  dateSelect(e) {
    ...
    console.log("date_investigation_commenced", this.date_investigation_commenced)
  }
  ...
  ionViewWillEnter() {
    ...
    if (this.isFrom =='edit') {
      console.log("fromEdit log", d.investigation_details);
      console.log()
      ...
      console.log("chekBoxDetails", chekBoxDetails);
