(function () {
  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_form-list_form-list_module_ts"], {
    /***/
    38550:
    /*!**********************************************************************************************!*\
    ...
    19541:
    /*!*************************************************************!*\
      !*** ./src/app/pages/form-list/form-list-routing.module.ts ***!
      \*************************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "FormListPageRoutingModule": function FormListPageRoutingModule() {
          return (
            /* binding */
            _FormListPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _form_list_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./form-list.page */
      41467);

      var routes = [{
        path: '',
        component: _form_list_page__WEBPACK_IMPORTED_MODULE_0__.FormListPage
      }];

      var _FormListPageRoutingModule = function FormListPageRoutingModule() {
        _classCallCheck(this, FormListPageRoutingModule);
      };

      _FormListPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    37114:
    /*!*****************************************************!*\
      !*** ./src/app/pages/form-list/form-list.module.ts ***!
      \*****************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "FormListPageModule": function FormListPageModule() {
          return (
            /* binding */
            _FormListPageModule
          );
      ...
      var _form_list_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./form-list-routing.module */
      19541);
      /* harmony import */


      var _form_list_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./form-list.page */
      41467);

      var _FormListPageModule = function FormListPageModule() {
        _classCallCheck(this, FormListPageModule);
      };

      _FormListPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _form_list_routing_module__WEBPACK_IMPORTED_MODULE_0__.FormListPageRoutingModule, _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_7__.NgxDatatableModule],
        declarations: [_form_list_page__WEBPACK_IMPORTED_MODULE_1__.FormListPage],
    ...
    41467:
    /*!***************************************************!*\
      !*** ./src/app/pages/form-list/form-list.page.ts ***!
      \***************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "FormListPage": function FormListPage() {
          return (
            /* binding */
            _FormListPage
          );
      ...
      var _raw_loader_form_list_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./form-list.page.html */
      1575);
      /* harmony import */


      var _form_list_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./form-list.page.scss */
      77918);
      /* harmony import */
      ...
      var _FormListPage = /*#__PURE__*/function () {
        function FormListPage(nav, global) {
        ...
        _createClass(FormListPage, [{
          ...
          value: function getInvestigatorDetails() {
            ...
            this.global.getData("api/Investigator/getInvestigator").subscribe(function (res) {
              if (res) {
                _this28.listOfUsers = res.data;
              }
            }, function (err) {
              console.log(err);
            });
          ...
          value: function ionViewWillEnter() {
            ...
            this.supervisorRole = this.global.supervisior; // if (this.platform.is('mobileweb')) {
            //   this.isApp = false;
            // } else {
            //   this.isApp = true;
            // }
            ...
            if (this.role == this.investigatorRole) {
              this.global.postData("api/Add_form/get", {
                investigator_id: this.gm_id
              }).subscribe(function (res) {
                var _a; // this.global.presentLoading()


                if (res) {
                  var data = [];
                  (_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.forEach(function (el, index) {
                    el.no = index + 1;
                    el.incident_type = el.incident_value;
                    el.noc = moment__WEBPACK_IMPORTED_MODULE_2__(el.created_at, "YYYY-MM-DD HH:m:ss").format("DD-MM-YYYY");
                    el.time = moment__WEBPACK_IMPORTED_MODULE_2__(el.created_at, "YYYY-MM-DD HH:m:ss").format("h:mm a");
                    el.manager = el.classification_manager;
                    el.inValue = el.incident_value;
                    el.role;
                    el.cStatus = el.complete_status;
                  });
                  _this29.listData = res.data;

                  _this29.listData.forEach(function (element) {
                    if (element.complete_status == 1) {
                      data.push(element);
                    }
                  });

                  _this29.rows = _this29.listData;
                  _this29.investigatorData = data;
              ...
              this.global.postData("api/add_form/get", {}).subscribe(function (res) {
                var _a, _b; // this.global.presentLoading()


                if (res) {
                  if (_this29.role == _this29.gmRole) {
                    var data = [];
                    (_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.forEach(function (el, index) {
                      el.no = index + 1;
                      el.incident_type = el.incident_value;
                    ...
                    _this29.listData = data;
                    _this29.rows = data;
                  } else {
                    (_b = res === null || res === void 0 ? void 0 : res.data) === null || _b === void 0 ? void 0 : _b.forEach(function (el, index) {
                      el.no = index + 1;
                      el.incident_type = el.incident_value;
                      el.noc = moment__WEBPACK_IMPORTED_MODULE_2__(el.created_at, "YYYY-MM-DD HH:m:ss").format("DD-MM-YYYY");
                      el.time = moment__WEBPACK_IMPORTED_MODULE_2__(el.created_at, "YYYY-MM-DD HH:m:ss").format("h:mm a");
                ...
                } else {// this.global.dismissLoading();
                }
              }, function (error) {
                console.log(error); // this.global.dismissLoading();
              });
            }
              ...
              if (res) {
                if (_this29.role == _this29.gmRole) {
                  ...
                  (_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.forEach(function (el, index) {
                    ...
                    if (((_a = el === null || el === void 0 ? void 0 : el.investigation_details) === null || _a === void 0 ? void 0 : _a.name) != null) {
                      el.investigator = (_c = (_b = el === null || el === void 0 ? void 0 : el.investigation_details) === null || _b === void 0 ? void 0 : _b.name[0]) === null || _c === void 0 ? void 0 : _c.investigator_name;
                    }
          ...
          value: function viewInvestigation() {
          ...
          key: "assignToinvestigator",
          value: function assignToinvestigator() {
            var fd = new FormData();
            var data = JSON.parse(localStorage.getItem("singleView"));
          ...
          key: "selectInvestigator",
          value: function selectInvestigator(e) {
            var _this30 = this;
            ...
            this.listOfUsers.forEach(function (user) {
              if (user.full_name == e.detail.value) {
                _this30.investigator_id = user.id;
              }
            });
            var fd = new FormData();
            var data = JSON.parse(localStorage.getItem("singleView"));
            ...
            fd.append("investigator_name", this.investigator_name); // let datas = {
            //   incident_id: data.id,
            //   gmL: this.gm_id,
      ...
      _FormListPage.ctorParameters = function () {
        return [{
      ...
      _FormListPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-form-list',
        template: _raw_loader_form_list_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
        styles: [_form_list_page_scss__WEBPACK_IMPORTED_MODULE_1__["default"]]
      })], _FormListPage);
      /***/
    },
    ...
    77918:
    /*!*****************************************************!*\
      !*** ./src/app/pages/form-list/form-list.page.scss ***!
      \*****************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "ion-content ion-label {\n  white-space: normal;\n}\nion-content .toolbar {\n  background-color: var(--theme-blue-color);\n  align-items: center;\n  align-content: center;\n  color: white;\n  text-align: center;\n  justify-content: center;\n  align-self: center;\n  padding: 40px;\n  font-family: \"mon-bold\";\n  font-size: 19px;\n  text-transform: uppercase;\n}\nion-content .container {\n  background-color: white;\n  border-top-left-radius: 32px;\n  padding: 20px;\n  border-top-right-radius: 32px;\n  margin-top: -25px;\n  padding-bottom: 0px;\n}\nion-content .container .logo {\n  padding-top: 80px;\n}\nion-content .container ion-item {\n  --inner-padding-end: 0px;\n}\nion-content .container ion-item ion-label {\n  font-family: \"mon-medium\";\n  white-space: normal;\n  color: var(--black-color);\n  font-size: 21px;\n}\nion-content .container ion-item ion-input {\n  font-family: \"mon-medium\";\n  color: var(--black-color);\n  font-size: 16px;\n  border: 1px solid #c3c3c3;\n  border-radius: 20px;\n  margin-top: 14px;\n  --padding-top: 12px;\n  --padding-bottom: 12px;\n  --padding-start: 12px;\n  --padding-end: 12px;\n}\nion-content .container .login-btn {\n  width: 100%;\n  border-radius: 23px;\n  --border-radius: 23px;\n  font-family: \"mon-bold\";\n  color: white;\n  --background: var(--theme-blue-color);\n  height: 50px;\n  overflow: hidden;\n  margin-top: 13px;\n  text-transform: capitalize;\n  font-size: 16px;\n  margin-bottom: 8px;\n}\nion-content .container .input-div {\n  margin-top: 25px;\n}\nion-content .back {\n  position: absolute;\n  left: 0;\n  top: 29px;\n  font-family: \"mon-bold\";\n  font-size: 29px;\n}\nion-content .logout {\n  position: absolute;\n  right: 0;\n  top: 29px;\n  font-family: \"mon-bold\";\n  font-size: 29px;\n}\nion-content p {\n  font-family: \"mon-medium\";\n  color: var(--theme-blue-color);\n  font-size: 20px;\n  margin-top: 10px;\n}\nion-content .btnView {\n  margin-top: 100px;\n}\nion-content .plus {\n  height: 18px;\n  width: 18px;\n  -o-object-fit: contain;\n     object-fit: contain;\n}\nion-content .inci {\n  width: 100%;\n  margin: 0;\n  --background: #e0e0e0;\n  overflow: hidden !important;\n  height: 52px;\n  --border-radius: 31px;\n  border-radius: 31px;\n  align-items: flex-start;\n  align-content: flex-start;\n  justify-content: flex-start;\n  margin-bottom: 24px;\n}\nion-content .inci p {\n  font-family: \"mon-bold\";\n  text-transform: capitalize;\n  text-align: left;\n  justify-content: flex-start;\n  position: absolute;\n  left: 0;\n  top: 5px;\n  color: #313131;\n  font-size: 20px;\n}\nion-content .inci img {\n  margin-top: 3px;\n  position: absolute;\n  right: 0;\n}\nion-content .questionHead {\n  font-family: mon-black;\n}\nion-content .activeBackground {\n  border-radius: 20px;\n  margin-bottom: 22px;\n  background-color: #f3f3f3;\n  padding: 15px;\n}\nion-content .activeBackground p {\n  font-family: \"mon-bold\";\n  text-transform: capitalize;\n  text-align: left;\n  justify-content: flex-start;\n  color: #313131;\n  font-size: 20px;\n}\nion-content .activeBackground .headerTitle {\n  display: flex;\n  align-items: center;\n}\nion-content .activeBackground .headerTitle img {\n  position: absolute;\n  right: 33px;\n  margin-top: -8px;\n}\nion-content .ra {\n  --background: transparent;\n  padding: 0;\n  margin: 0;\n  --padding-top: 0px;\n  --inner-padding-top: 0;\n  --inner-padding-end: 0;\n  --inner-padding-bottom: 0;\n  --inner-padding-start: 0;\n  --padding-bottom: 0;\n  --padding-start: 0;\n  --padding-end: 0;\n}\nion-content .ra ion-label {\n  font-family: \"mon-medium\";\n  font-size: 17px;\n  color: var(--black-color);\n}\nion-content ion-radio {\n  margin-right: 7px;\n}\nion-content ion-checkbox {\n  --border-color: var(--theme-blue-color);\n}\nion-content ion-col {\n  padding: 0;\n}\nion-content hr {\n  height: 1px;\n  background: #cccccc;\n  margin-top: 0px;\n  margin-bottom: 0px;\n}\nion-content ion-radio {\n  --color: var(--theme-blue-color);\n}\nion-content .question {\n  font-size: 14px !important;\n}\nion-content ion-list {\n  --background: transparent !important;\n  background: transparent !important;\n}\nion-content ion-list ion-item {\n  --background: transparent !important;\n  background: transparent !important;\n}\nion-content ion-list ion-item ion-label {\n  font-family: mon-medium;\n}\nion-content ion-select {\n  width: 100%;\n  background: white;\n  border-radius: 20px;\n  --padding-start: 15px;\n  font-family: \"mon-medium\";\n  color: var(--black-color);\n  --padding-end: 15px;\n}\nion-content ion-input {\n  background: white;\n  border-radius: 20px;\n  font-family: \"mon-medium\";\n  --padding-start: 10px;\n  --padding-end: 10px;\n  --padding-top: 10px;\n}\nion-content .labelCustomDropDown {\n  margin-left: 12px;\n}\nion-content .camera {\n  font-family: mon-medium;\n  margin-top: 16px;\n}\nion-content ion-datetime {\n  font-family: \"mon-medium\";\n}\nion-content ion-card {\n  margin: 0;\n  padding: 16px;\n  border-radius: 19px;\n  margin-bottom: 15px;\n}\nion-content .view {\n  font-size: 20px;\n  color: var(--theme-blue-color);\n}\n.dropDownStyle {\n  --inner-padding-end:0px;\n  --background:transparent;\n  margin-top: -10px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    1575:
    /*!*******************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/form-list/form-list.page.html ***!
      \*******************************************************************************************/
...
//# sourceMappingURL=src_app_pages_form-list_form-list_module_ts-es5.js.map