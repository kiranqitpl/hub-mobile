    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _IncidentFormEditPage = /*#__PURE__*/function () {
        ...
        function IncidentFormEditPage(globalService, sharedService, modalController, actionSheetController, camera, fb, nav, platform, activatedRoute, loadingService) {
          ...
          this.form_percent = 0;
          this.form_percent_val = 0; //-------------------------------------------------- Dropdowns variables---------------------------------------------------------------//
        ...
        _createClass(IncidentFormEditPage, [{
          ...
          value: function loadIncidentDetails() {
            ...
            this.activatedRoute.params.subscribe(function (params) {
              _this8.globalService.getData('add_form/getSingleData?table_name=add_form&id=' + params['incident_id']).subscribe(function (result) {
                ...
                _this8.onProgressBar('', ''); // this.loadingService.dismissLoading();
                      ...
                      if (type == 1) {
                        ...
                        for (i = 0; i < event.target.files.length; i++) {
                          this.sharedService.getBase64(event.target.files[i]).then(function (image) {
                            ...
                            _this12.photoGraphyForm.controls['photography_image'].setValue(_this12.photoGraphy);
            ...
            if (type == 1) {
              ...
              for (var i = 0; i < event.target.files.length; i++) {
                this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  ...
                  _this13.incidentDesForm.controls['alcohol_test_image'].setValue(_this13.alcohalImages);
            ...
            if (type == 1) {
              ...
              for (var i = 0; i < event.target.files.length; i++) {
                this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  ...
                  _this14.incidentDesForm.controls['drug_test_image'].setValue(_this14.drugTestImages);

                  _this14.onProgressBar('', '');
                })["catch"](function (error) {
                  console.log('error', error);
                });
              }
            ...
            if (type == 1) {
              ...
              for (var i = 0; i < event.target.files.length; i++) {
                this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  ...
                  _this16.assetDescriptionForm.controls['extent_damage_image'].setValue(_this16.damageImages);

                  _this16.onProgressBar('', '');
                })["catch"](function (error) {
                  console.log('error', error);
                });
              }
            ...
            if (type == 1) {
              ...
              for (var i = 0; i < event.target.files.length; i++) {
                this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  ...
                  _this17.enviornmentForm.controls['chemical_details'].patchValue(image);

                  _this17.onProgressBar('', '');
                })["catch"](function (error) {
                  console.log('error', error);
                });
              }
              ...
              if (this.incidentDesForm.valid) {
                ...
                this.classificationList.forEach(function (element) {
                  if (element.val == 'Asset' && element.isChecked) {
                    Object.keys(_this27.assetDescriptionForm.controls).map(function (ele) {
                      return formControlKeys.push(ele);
                    });
                    Object.values(_this27.assetDescriptionForm.value).map(function (ele) {
                      return formControlValue.push(ele);
                    });
                  }

                  if (element.val == 'Environmental' && element.isChecked) {
                    Object.keys(_this27.enviornmentForm.controls).map(function (ele) {
                      return formControlKeys.push(ele);
                    });
                    Object.values(_this27.enviornmentForm.value).map(function (ele) {
                      return formControlValue.push(ele);
                    });
                  }
                  ...
                  if (element.val == 'Injury' && element.isChecked) {
                    ...
                    formControlValue.push(_this27.injuryForm.value['injury_persons']);
                  }

                  if (element.val == "Report" && element.isChecked) {
                    Object.keys(_this27.reportForm.controls).map(function (ele) {
                      return formControlKeys.push(ele);
                    });
                    Object.values(_this27.reportForm.value).map(function (ele) {
                      return formControlValue.push(ele);
                    });
                  } //--------------------------------------------------- Reputation Des Form -----------------------------------------------------------//  
                  ...
                  if (element.val == "Reputation" && element.isChecked) {
                    ...
                    formControlValue.push(_this27.reputationDesForm.value['reputation_option']);
                    formControlKeys.push('reputation_negative_effect');
                    formControlValue.push(_this27.reputationDesForm.value['reputation_negative_effect']);
                    formControlKeys.push('name_of_witness');
                    formControlValue.push(_this27.reputationDesForm.value['name_of_witness']);
                    formControlKeys.push('possible_outcome_incident');
                    formControlValue.push(_this27.reputationDesForm.value['possible_outcome_incident']);

                    if (_this27.reputationDesForm.value['reputation_option'] && _this27.reputationDesForm.value['reputation_option'].length > 0) {
                      if (_this27.reputationDesForm.value['reputation_option'][0] == "Company" || _this27.reputationDesForm.value['reputation_option'][1] == "Company") {
                        formControlKeys.push('company_damage_value');
                        formControlValue.push(_this27.reputationDesForm.value['company_damage_value']);
                      }

                      if (_this27.reputationDesForm.value['reputation_option'][0] == "Individual" || _this27.reputationDesForm.value['reputation_option'][1] == "Individual") {
                        formControlKeys.push('individual_damage_value');
                        formControlValue.push(_this27.reputationDesForm.value['individual_damage_value']);
                      }
                    }

                    if (_this27.reputationDesForm.value['reputation_negative_effect'] != '' && _this27.reputationDesForm.value['reputation_negative_effect'] == 'Internal') {
                      formControlKeys.push('effected_department');
                      formControlValue.push(_this27.reputationDesForm.value['effected_department']);
                    } else if (_this27.reputationDesForm.value['reputation_negative_effect'] != '' && _this27.reputationDesForm.value['reputation_negative_effect'] == "External") {
                      formControlKeys.push('external_party');
                      formControlValue.push(_this27.reputationDesForm.value['external_party']);
                    } else if (_this27.reputationDesForm.value['reputation_negative_effect'] == 'Both') {
                      formControlKeys.push('effected_department');
                      formControlValue.push(_this27.reputationDesForm.value['effected_department']);
                      formControlKeys.push('external_party');
                      formControlValue.push(_this27.reputationDesForm.value['external_party']);
                    ...
                    if (_this27.reputationDesForm.value['name_of_witness'] == 'Other') {
                      formControlKeys.push('other_witness_name');
                      formControlValue.push(_this27.reputationDesForm.value['other_witness_details'].other_witness_name);
                      formControlKeys.push('other_witness_mobile_no');
                      formControlValue.push(_this27.reputationDesForm.value['other_witness_details'].other_witness_mobile_no);
                      formControlKeys.push('other_witness_email');
                      formControlValue.push(_this27.reputationDesForm.value['other_witness_details'].other_witness_email);
                    }
                  } //----------------------------------------------- Reputation Des Form ---------------------------------------------------------------//
                  ...
                  if (element.val == "Security" && element.isChecked) {
                    ...
                    formControlValue.push(_this27.securityForm.value['security_option']);

                    if (_this27.securityForm.value['security_option'] == 'IT') {
                      formControlKeys.push('it_option_value');
                      formControlValue.push(_this27.securityForm.value['it_option_value']);
                    }

                    if (_this27.securityForm.value['security_option'] == 'Theft') {
                      formControlKeys.push('what_has_been_stolen_item');
                      formControlValue.push(_this27.securityForm.value['what_has_been_stolen_item']);
                      formControlKeys.push('approximate_value_of_stolen');
                      formControlValue.push(_this27.securityForm.value['approximate_value_of_stolen']);
                    }

                    if (_this27.securityForm.value['security_option'] == 'Other') {
                      formControlKeys.push('what_is_the_specific_securities_incident');
                      formControlValue.push(_this27.securityForm.value['what_is_the_specific_securities_incident']);
                    } //---------------------------------------------------- Security Form ----------------------------------------------------------------//  
                ...
                if (this.injuryForm.value['injury_persons'] != '' && this.injuryForm.value['injury_persons'] != null) {
                  var _loop = function _loop(_i7) {
                    Object.keys(_this27.injuryForm.value['person_details'][_i7]).forEach(function (ele, j) {
                      if (ele != 'injured_person_option_id' && ele != 'injured_person_option_other_details' && ele != 'normal_duties_explanation' && ele != 'duties_explanation' && ele != 'immediate_treatment_person_name_id' && ele != 'immediate_treatment_given_explanation' && ele != 'immediate_treatment_person_name' && ele != 'immediate_treatment_other_person_detail' && ele != 'was_immediate_treatment_comment') {
                        formControlKeys.push(ele + '_' + _i7);
                        formControlValue.push(Object.values(_this27.injuryForm.value['person_details'][_i7])[j]);
                      }

                      if (ele == 'injured_person_option' && _this27.injuryForm.value['person_details'][_i7].injured_person_option == 'Other') {
                        formControlKeys.push('injured_person_option_other_name' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['injured_person_option_other_details'].injured_person_option_other_name);
                        formControlKeys.push('injured_person_option_other_mobile_no' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['injured_person_option_other_details'].injured_person_option_other_mobile_no);
                        formControlKeys.push('injured_person_option_other_email' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['injured_person_option_other_details'].injured_person_option_other_email);
                      }

                      if (ele == 'normal_duties' && _this27.injuryForm.value['person_details'][_i7].normal_duties == 'No') {
                        formControlKeys.push('normal_duties_explanation' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['normal_duties_explanation']);
                      }

                      if (ele == 'alternate_duties' && _this27.injuryForm.value['person_details'][_i7].alternate_duties == 'No') {
                        formControlKeys.push('duties_explanation' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['duties_explanation']);
                      }

                      if (ele == 'was_immediate_treatment' && _this27.injuryForm.value['person_details'][_i7].was_immediate_treatment == 'Yes') {
                        formControlKeys.push('immediate_treatment_given_explanation' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7].immediate_treatment_given_explanation);
                        formControlKeys.push('immediate_treatment_person_name' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7].immediate_treatment_person_name);

                        if (_this27.injuryForm.value['person_details'][_i7]['immediate_treatment_person_name'] == 'Other') {
                          formControlKeys.push('immediate_treatment_other_name' + '_' + _i7);
                          formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['immediate_treatment_other_person_detail'].immediate_treatment_other_name);
                        }

                        formControlKeys.push('immediate_treatment_person_number' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['immediate_treatment_other_person_detail'].immediate_treatment_person_number);
                        formControlKeys.push('immediate_treatment_other_email' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7]['immediate_treatment_other_person_detail'].immediate_treatment_other_email);
                      }

                      if (ele == 'was_immediate_treatment' && _this27.injuryForm.value['person_details'][_i7].was_immediate_treatment == 'No') {
                        formControlKeys.push('was_immediate_treatment_comment' + '_' + _i7);
                        formControlValue.push(_this27.injuryForm.value['person_details'][_i7].was_immediate_treatment_comment);
                      }
                    });
                  };

                  for (var _i7 = 0; _i7 < this.injuryForm.value['injury_persons']; _i7++) {
                    _loop(_i7);
                  }
                } //------------------------------------------------------- Injury Form ---------------------------------------------------------------//    
          ...
          key: "onImageClick",
          value: function onImageClick(val) {
            console.log(val);
          }
        }]);
