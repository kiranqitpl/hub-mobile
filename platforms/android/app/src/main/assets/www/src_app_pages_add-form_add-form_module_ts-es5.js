    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AddFormPage = /*#__PURE__*/function () {
        function AddFormPage(nav, modal, camera, actionSheetController, file, global, base64, platform) {
          ...
          this.platformCheck = '';
          this.minDate = ""; //added field

          this.dateOfIncident = "";
          this.timeOfIncident = "";
          this.dateReported = "";
          this.timeReported = "";
          this.wasThereAnyWitnessOfIncident = ""; // alcoholTestCompleted:any = "" ; variable = alcoholTest
          // alcoholTestDocument:any = "" ; = imagePath2
          //drugTest:any = "" ; 
          // drugTestImage:any = "" ; variable = drugImage

          this.normalDutiesExplanation = "";
          this.partOfBodyInjured = ""; // wasImmediateTreatment:any = "" ; injurry
          ...
          this.url = '';
          this.selectedTime = "";
          this.selectedDateReported = "";
          this.selectedTimeReported = "";
        ...
        _createClass(AddFormPage, [{
          ...
          value: function pickImage(sourceType, e) {
            ...
            this.camera.getPicture(options).then(function (imageData) {
              var file = _this2.DataURIToBlob('data:image/jpeg;base64,' + imageData);

              if (e == 1) {
                _this2.imagePath = 'data:image/jpeg;base64,' + imageData;

                var t = _this2.DataURIToBlob('data:image/jpeg;base64,' + imageData);

                var realData = _this2.imagePath.split(",")[1];

                _this2.imageUri = imageData;
              }

              if (e == 2) {
                _this2.imagePath2 = 'data:image/jpeg;base64,' + imageData;

                var _t = _this2.DataURIToBlob('data:image/jpeg;base64,' + imageData);

                _this2.image2Uri = imageData;
              }

              if (e == 3) {
                _this2.imagePath3 = 'data:image/jpeg;base64,' + imageData;
                _this2.image3Uri = imageData;
              }

              if (e == 4) {
                _this2.imagePath4 = 'data:image/jpeg;base64,' + imageData;
                _this2.image4Uri = imageData;
              }

              if (e == 5) {
                _this2.imagePath5 = 'data:image/jpeg;base64,' + imageData;
                _this2.image5Uri = imageData;
              }

              if (e == 6) {
                _this2.drugImage = 'data:image/jpeg;base64,' + imageData;
