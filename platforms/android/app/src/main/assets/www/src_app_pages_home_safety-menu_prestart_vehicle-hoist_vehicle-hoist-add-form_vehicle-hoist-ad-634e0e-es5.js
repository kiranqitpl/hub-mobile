      ...
      var _VehicleHoistAddFormPage = /*#__PURE__*/function () {
        ...
        _createClass(VehicleHoistAddFormPage, [{
          ...
          value: function scrollToBottom() {
            this.myScrollContainer.nativeElement.scrollTo(0, this.myScrollContainer.nativeElement.scrollHeight); //   this.myScrollContainer.nativeElement.scroll({
            //     top: this.myScrollContainer.nativeElement.scrollHeight,
            //     left: 0,
            //     behavior: 'smooth'
            //  });

            console.log('this.myScrollContainer.nativeElement', this.myScrollContainer.nativeElement); // try {
