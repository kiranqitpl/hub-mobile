...
let IncidentFormListPage = class IncidentFormListPage {
    constructor(nav, global, toastService, loadingService, sharedService) {
        this.nav = nav;
        this.global = global;
            ...
            this.global.getData('add_form/get/?page_no=' + this.pageNumber).subscribe((result) => {
                if (result && result.data && result.data.mforms_add_form && result.data.mforms_add_form.length > 0) {
                    ...
                    result.data.mforms_add_form.forEach((el) => {
                        ...
                        el.Date = moment__WEBPACK_IMPORTED_MODULE_5___default()(el.Date).format("DD-MM-YYYY hh:mm");
...
IncidentFormListPage = (0,tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([
    ...
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.HostListener)('window:resize', ['$event'])
