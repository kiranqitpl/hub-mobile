...
let VehicleHoistAddFormPage = class VehicleHoistAddFormPage {
    constructor(loadingService, toastService, navCtrl, fb, globalService, elementRef, alertService, activatedRoute) {
    ...
    submitDataInApi(complete_status) {
...
VehicleHoistAddFormPage.propDecorators = {
    content: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonContent, { static: false },] }],
    myScrollContainer: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: ['target',] }]
};
