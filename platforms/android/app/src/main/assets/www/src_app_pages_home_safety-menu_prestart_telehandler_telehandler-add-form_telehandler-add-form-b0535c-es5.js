  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_home_safety-menu_prestart_telehandler_telehandler-add-form_telehandler-add-form-b0535c"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _TelehandlerAddFormPage = /*#__PURE__*/function () {
        function TelehandlerAddFormPage(fb, globalService, toastService, nav, loadingService, modalController, sharedService, actionSheetController, camera) {
        ...
        _createClass(TelehandlerAddFormPage, [{
          ...
          value: function ngOnInit() {
            this.teleHandlerForm = this.fb.group({
              ...
              wheels_tyres: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              wheels_tyres_comment: [''],
              wheels_tyres_image: [''],
              fire_extinguisher: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              fire_extinguisher_comment: [''],
              fire_extinguisher_image: [''],
              fuel_flash: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              fuel_flash_comment: [''],
              fuel_flash_image: [''],
              hydraulics_functional: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              hydraulics_functional_comment: [''],
              hydraulics_functional_image: [''],
              lift_arms: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              lift_arms_comment: [''],
              lift_arms_image: [''],
              chain_hose: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              chain_hose_comment: [''],
              chain_hose_image: [''],
              cap_bolts: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              cap_bolts_comment: [''],
              cap_bolts_image: [''],
              safety_stops: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              safety_stops_comment: [''],
              safety_stops_image: [''],
              forks: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              forks_comment: [''],
              forks_image: [''],
              overhead_guards: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              overhead_guards_comment: [''],
              overhead_guards_image: [''],
              counterweight: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              counterweight_comment: [''],
              counterweight_image: [''],
              engine_bay_components: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              engine_bay_components_comment: [''],
              engine_bay_components_image: [''],
              horn: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              horn_comment: [''],
              horn_image: [''],
              audible: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              audible_comment: [''],
              audible_image: [''],
              headlights: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              headlights_comment: [''],
              headlights_image: [''],
              turn_signals: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              turn_signals_comment: [''],
              turn_signals_image: [''],
              warning_brake_lights: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              warning_brake_lights_comment: [''],
              warning_brake_lights_image: [''],
              foot_brake: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              foot_brake_comment: [''],
              foot_brake_image: [''],
              parking_brake: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              parking_brake_comment: [''],
              parking_brake_image: [''],
              clutch_gear_shift: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              clutch_gear_shift_comment: [''],
              clutch_gear_shift_image: [''],
              engine_noise: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              engine_noise_comment: [''],
              engine_noise_image: [''],
              dash_gauges: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              dash_gauges_comment: [''],
              dash_gauges_image: [''],
              operational_controls: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              operational_controls_comment: [''],
              operational_controls_image: [''],
              fluid_leaks: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
              fluid_leaks_comment: [''],
              fluid_leaks_image: [''],
              first_aid_kit: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required],
                    ...
                    case 0:
                      ...
                      this.camera.getPicture(options).then(function (imageData) {
                        ...
                        if (rowName == 'data_plate_image') {
                          _this.teleHandlerForm.controls['data_plate_image'].setValue(image);
                        } else if (rowName == 'engine_oil_image') {
                          _this.teleHandlerForm.controls['engine_oil_image'].setValue(image);
                        } else if (rowName == 'hydraulic_oil_image') {
                          _this.teleHandlerForm.controls['hydraulic_oil_image'].setValue(image);
                        } else if (rowName == 'equipment_inspect_image') {
                          _this.teleHandlerForm.controls['equipment_inspect_image'].setValue(image);
                        } else if (rowName == 'coolant_level_image') {
                          _this.teleHandlerForm.controls['coolant_level_image'].setValue(image);
                        } else if (rowName == 'belts_and_hoses_image') {
                          _this.teleHandlerForm.controls['belts_and_hoses_image'].setValue(image);
                        } else if (rowName == 'wheels_tyres_image') {
                          _this.teleHandlerForm.controls['wheels_tyres_image'].setValue(image);
                        } else if (rowName == 'fire_extinguisher_image') {
                          _this.teleHandlerForm.controls['fire_extinguisher_image'].setValue(image);
                        } else if (rowName == 'fuel_flash_image') {
                          _this.teleHandlerForm.controls['fuel_flash_image'].setValue(image);
                        } else if (rowName == 'hydraulics_functional_image') {
                          _this.teleHandlerForm.controls['hydraulics_functional_image'].setValue(image);
                        } else if (rowName == 'lift_arms_image') {
                          _this.teleHandlerForm.controls['lift_arms_image'].setValue(image);
                        } else if (rowName == 'chain_hose_image') {
                          _this.teleHandlerForm.controls['chain_hose_image'].setValue(image);
                        } else if (rowName == 'cap_bolts_image') {
                          _this.teleHandlerForm.controls['cap_bolts_image'].setValue(image);
                        } else if (rowName == 'safety_stops_image') {
                          _this.teleHandlerForm.controls['safety_stops_image'].setValue(image);
                        } else if (rowName == 'forks_image') {
                          _this.teleHandlerForm.controls['forks_image'].setValue(image);
                        } else if (rowName == 'overhead_guards_image') {
                          _this.teleHandlerForm.controls['overhead_guards_image'].setValue(image);
                        } else if (rowName == 'counterweight_image') {
                          _this.teleHandlerForm.controls['counterweight_image'].setValue(image);
                        } else if (rowName == 'engine_bay_components_image') {
                          _this.teleHandlerForm.controls['engine_bay_components_image'].setValue(image);
                        } else if (rowName == 'horn_image') {
                          _this.teleHandlerForm.controls['horn_image'].setValue(image);
                        } else if (rowName == 'audible_image') {
                          _this.teleHandlerForm.controls['audible_image'].setValue(image);
                        } else if (rowName == 'headlights_image') {
                          _this.teleHandlerForm.controls['headlights_image'].setValue(image);
                        } else if (rowName == 'turn_signals_image') {
                          _this.teleHandlerForm.controls['turn_signals_image'].setValue(image);
                        } else if (rowName == 'warning_brake_lights_image') {
                          _this.teleHandlerForm.controls['warning_brake_lights_image'].setValue(image);
                        } else if (rowName == 'foot_brake_image') {
                          _this.teleHandlerForm.controls['foot_brake_image'].setValue(image);
                        } else if (rowName == 'parking_brake_image') {
                          _this.teleHandlerForm.controls['parking_brake_image'].setValue(image);
                        } else if (rowName == 'clutch_gear_shift_image') {
                          _this.teleHandlerForm.controls['clutch_gear_shift_image'].setValue(image);
                        } else if (rowName == 'engine_noise_image') {
                          _this.teleHandlerForm.controls['engine_noise_image'].setValue(image);
                        } else if (rowName == 'dash_gauges_image') {
                          _this.teleHandlerForm.controls['dash_gauges_image'].setValue(image);
                        } else if (rowName == 'operational_controls_image') {
                          _this.teleHandlerForm.controls['operational_controls_image'].setValue(image);
                        } else if (rowName == 'fluid_leaks_image') {
                          _this.teleHandlerForm.controls['fluid_leaks_image'].setValue(image);
                        } else if (rowName == 'first_aid_kit_image') {
                          _this.teleHandlerForm.controls['first_aid_kit_image'].setValue(image);
                        }
                      }, function (err) {
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this2.pickImage(_this2.camera.PictureSourceType.PHOTOLIBRARY, rowName);
                          }
                        }, {
                          text: 'Use Camera',
                          handler: function handler() {
                            _this2.pickImage(_this2.camera.PictureSourceType.CAMERA, rowName);
                          }
                        }, {
                          text: 'Cancel',
                          role: 'cancel'
                  ...
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      if (type == 1) {
                        ...
                        this.sharedService.getBase64(event.target.files[0]).then(function (image) {
                          if (rowName == 'data_plate_image') {
                            _this3.teleHandlerForm.controls['data_plate_image'].setValue(image);
                          } else if (rowName == 'engine_oil_image') {
                            _this3.teleHandlerForm.controls['engine_oil_image'].setValue(image);
                          } else if (rowName == 'hydraulic_oil_image') {
                            _this3.teleHandlerForm.controls['hydraulic_oil_image'].setValue(image);
                          } else if (rowName == 'equipment_inspect_image') {
                            _this3.teleHandlerForm.controls['equipment_inspect_image'].setValue(image);
                          } else if (rowName == 'coolant_level_image') {
                            _this3.teleHandlerForm.controls['coolant_level_image'].setValue(image);
                          } else if (rowName == 'belts_and_hoses_image') {
                            _this3.teleHandlerForm.controls['belts_and_hoses_image'].setValue(image);
                          } else if (rowName == 'wheels_tyres_image') {
                            _this3.teleHandlerForm.controls['wheels_tyres_image'].setValue(image);
                          } else if (rowName == 'fire_extinguisher_image') {
                            _this3.teleHandlerForm.controls['fire_extinguisher_image'].setValue(image);
                          } else if (rowName == 'fuel_flash_image') {
                            _this3.teleHandlerForm.controls['fuel_flash_image'].setValue(image);
                          } else if (rowName == 'hydraulics_functional_image') {
                            _this3.teleHandlerForm.controls['hydraulics_functional_image'].setValue(image);
                          } else if (rowName == 'lift_arms_image') {
                            _this3.teleHandlerForm.controls['lift_arms_image'].setValue(image);
                          } else if (rowName == 'chain_hose_image') {
                            _this3.teleHandlerForm.controls['chain_hose_image'].setValue(image);
                          } else if (rowName == 'cap_bolts_image') {
                            _this3.teleHandlerForm.controls['cap_bolts_image'].setValue(image);
                          } else if (rowName == 'safety_stops_image') {
                            _this3.teleHandlerForm.controls['safety_stops_image'].setValue(image);
                          } else if (rowName == 'forks_image') {
                            _this3.teleHandlerForm.controls['forks_image'].setValue(image);
                          } else if (rowName == 'overhead_guards_image') {
                            _this3.teleHandlerForm.controls['overhead_guards_image'].setValue(image);
                          } else if (rowName == 'counterweight_image') {
                            _this3.teleHandlerForm.controls['counterweight_image'].setValue(image);
                          } else if (rowName == 'engine_bay_components_image') {
                            _this3.teleHandlerForm.controls['engine_bay_components_image'].setValue(image);
                          } else if (rowName == 'horn_image') {
                            _this3.teleHandlerForm.controls['horn_image'].setValue(image);
                          } else if (rowName == 'audible_image') {
                            _this3.teleHandlerForm.controls['audible_image'].setValue(image);
                          } else if (rowName == 'headlights_image') {
                            _this3.teleHandlerForm.controls['headlights_image'].setValue(image);
                          } else if (rowName == 'turn_signals_image') {
                            _this3.teleHandlerForm.controls['turn_signals_image'].setValue(image);
                          } else if (rowName == 'warning_brake_lights_image') {
                            _this3.teleHandlerForm.controls['warning_brake_lights_image'].setValue(image);
                          } else if (rowName == 'foot_brake_image') {
                            _this3.teleHandlerForm.controls['foot_brake_image'].setValue(image);
                          } else if (rowName == 'parking_brake_image') {
                            _this3.teleHandlerForm.controls['parking_brake_image'].setValue(image);
                          } else if (rowName == 'clutch_gear_shift_image') {
                            _this3.teleHandlerForm.controls['clutch_gear_shift_image'].setValue(image);
                          } else if (rowName == 'engine_noise_image') {
                            _this3.teleHandlerForm.controls['engine_noise_image'].setValue(image);
                          } else if (rowName == 'dash_gauges_image') {
                            _this3.teleHandlerForm.controls['dash_gauges_image'].setValue(image);
                          } else if (rowName == 'operational_controls_image') {
                            _this3.teleHandlerForm.controls['operational_controls_image'].setValue(image);
                          } else if (rowName == 'fluid_leaks_image') {
                            _this3.teleHandlerForm.controls['fluid_leaks_image'].setValue(image);
                          } else if (rowName == 'first_aid_kit_image') {
                            _this3.teleHandlerForm.controls['first_aid_kit_image'].setValue(image);
                          }
          ...
          key: "onDeleteImage",
          value: function onDeleteImage(rowName) {
            if (rowName == 'data_plate_image') {
          ...
          value: function onSubmit() {
            ...
            if (this.teleHandlerForm.value['data_plate'] == 'Faulty' && this.teleHandlerForm.value['data_plate_comment'] == '' || this.teleHandlerForm.value['engine_oil'] == 'Faulty' && this.teleHandlerForm.value['engine_oil_comment'] == '' || this.teleHandlerForm.value['hydraulic_oil'] == 'Faulty' && this.teleHandlerForm.value['hydraulic_oil_comment'] == '' || this.teleHandlerForm.value['equipment_inspect'] == 'Faulty' && this.teleHandlerForm.value['equipment_inspect_comment'] == '' || this.teleHandlerForm.value['coolant_level'] == 'Faulty' && this.teleHandlerForm.value['coolant_level_comment'] == '' || this.teleHandlerForm.value['belts_and_hoses'] == 'Faulty' && this.teleHandlerForm.value['belts_and_hoses_comment'] == '' || this.teleHandlerForm.value['wheels_tyres'] == 'Faulty' && this.teleHandlerForm.value['wheels_tyres_comment'] == '' || this.teleHandlerForm.value['fire_extinguisher'] == 'Faulty' && this.teleHandlerForm.value['fire_extinguisher_comment'] == '' || this.teleHandlerForm.value['fuel_flash'] == 'Faulty' && this.teleHandlerForm.value['fuel_flash_comment'] == '' || this.teleHandlerForm.value['hydraulics_functional'] == 'Faulty' && this.teleHandlerForm.value['hydraulics_functional_comment'] == '' || this.teleHandlerForm.value['lift_arms'] == 'Faulty' && this.teleHandlerForm.value['lift_arms_comment'] == '' || this.teleHandlerForm.value['chain_hose'] == 'Faulty' && this.teleHandlerForm.value['chain_hose_comment'] == '' || this.teleHandlerForm.value['cap_bolts'] == 'Faulty' && this.teleHandlerForm.value['cap_bolts_comment'] == '' || this.teleHandlerForm.value['safety_stops'] == 'Faulty' && this.teleHandlerForm.value['safety_stops_comment'] == '' || this.teleHandlerForm.value['forks'] == 'Faulty' && this.teleHandlerForm.value['forks_comment'] == '' || this.teleHandlerForm.value['overhead_guards'] == 'Faulty' && this.teleHandlerForm.value['overhead_guards_comment'] == '' || this.teleHandlerForm.value['counterweight'] == 'Faulty' && this.teleHandlerForm.value['counterweight_comment'] == '' || this.teleHandlerForm.value['engine_bay'] == 'Faulty' && this.teleHandlerForm.value['engine_bay_components_comment'] == '' || this.teleHandlerForm.value['horn'] == 'Faulty' && this.teleHandlerForm.value['horn_comment'] == '' || this.teleHandlerForm.value['audible'] == 'Faulty' && this.teleHandlerForm.value['audible_comment'] == '' || this.teleHandlerForm.value['headlights'] == 'Faulty' && this.teleHandlerForm.value['headlights_comment'] == '' || this.teleHandlerForm.value['turn_signals'] == 'Faulty' && this.teleHandlerForm.value['turn_signals_comment'] == '' || this.teleHandlerForm.value['warning_brake_lights'] == 'Faulty' && this.teleHandlerForm.value['warning_brake_lights_comment'] == '' || this.teleHandlerForm.value['foot_brake'] == 'Faulty' && this.teleHandlerForm.value['foot_brake_comment'] == '' || this.teleHandlerForm.value['parking_brake'] == 'Faulty' && this.teleHandlerForm.value['parking_brake_comment'] == '' || this.teleHandlerForm.value['clutch_gear_shift'] == 'Faulty' && this.teleHandlerForm.value['clutch_gear_shift_comment'] == '' || this.teleHandlerForm.value['engine_noise'] == 'Faulty' && this.teleHandlerForm.value['engine_noise_comment'] == '' || this.teleHandlerForm.value['dash_gauges'] == 'Faulty' && this.teleHandlerForm.value['dash_gauges_comment'] == '' || this.teleHandlerForm.value['operational_controls'] == 'Faulty' && this.teleHandlerForm.value['operational_controls_comment'] == '' || this.teleHandlerForm.value['fluid_leaks'] == 'Faulty' && this.teleHandlerForm.value['fluid_leaks_comment'] == '' || this.teleHandlerForm.value['first_aid_kit'] == 'Faulty' && this.teleHandlerForm.value['first_aid_kit_comment'] == '') {
              ...
              if (this.teleHandlerForm.valid) {
                var formData = this.teleHandlerForm.value;
                formData['user_id'] = this.loggedInUser.id;
                var data = {
                  'formData': formData
                };
                this.globalService.postData('Telehandler/submit', data).subscribe(function (result) {
                  console.log('result', result);

                  if (result && result['status']) {
                    _this4.toastService.toast(result['message'], 'success');

                    _this4.nav.back();
                  } else {
                    _this4.toastService.toast(result['message'], 'danger');
                  }
                }, function (error) {
                  console.log('error', error);
                }); // this.loadingService.dismissLoading();
      ...
      _TelehandlerAddFormPage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
