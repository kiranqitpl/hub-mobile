            ...
            this.activatedRoute.params.subscribe(function (params) {
              _this8.globalService.getData('add_form/getIncidentFormByID/' + params['incident_id']).subscribe(function (result) {
                ...
                if (result && result['data'] && result['data'][0]) {
                  ...
                  _this8.classificationForm.controls['classification_manager'].setValue(_this8.incidentDetails.classification_manager); //------------------------------------------------------- classificationForm ----------------------------------------------------------//
                  ...
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          console.log('index', index);
                          console.log(_this19.injuryForm.controls['person_details']);

                          _this19.injuryForm.controls['person_details'][index].value['injured_person_option'].setValue(res.data.full_name);
