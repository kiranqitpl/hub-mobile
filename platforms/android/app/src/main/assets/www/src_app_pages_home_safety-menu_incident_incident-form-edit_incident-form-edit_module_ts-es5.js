(function () {
  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_home_safety-menu_incident_incident-form-edit_incident-form-edit_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_global_service_global_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var src_app_modals_managers_managers_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/modals/managers/managers.page */
      58127);
      /* harmony import */


      var src_app_modals_image_modal_image_modal_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _IncidentFormEditPage = /*#__PURE__*/function () {
        //-------------------------------------------------------- JSON DATA -------------------------------------------------------//
        function IncidentFormEditPage(globalService, sharedService, modalController, actionSheetController, camera, fb, nav, platform, activatedRoute) {
          ...
          this.platformCheck = '';
          this.incidentDetails = []; //----------------------------------------------------- Image variables ----------------------------------------------------//
        ...
        _createClass(IncidentFormEditPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.loadShift();
            this.loadSuperwiser();
            this.loadLocation(); // this.findValueInWitness();
          ...
          value: function loadEmployee() {
            ...
            this.globalService.getData1("user/getallemployee").subscribe(function (res) {
          ...
          value: function loadShift() {
            ...
            this.globalService.getData1("Shift/get_shift_typelist").subscribe(function (res) {
              if (res && res.status && res.data && res.data.length > 0) {
                _this3.shiftTypeList = res.data;
              } else {
                _this3.shiftTypeList = [];
              }
            }, function (err) {
          ...
          value: function loadBodyPart() {
            ...
            this.globalService.getData1("Body_part/getbodypart").subscribe(function (res) {
              if (res && res.status && res.data && res.data.length > 0) {
                _this6.bodyPartList = res.data;
              } else {
                _this6.bodyPartList = [];
              }
            }, function (err) {
          ...
          value: function loadIncidentDetails() {
            ...
            this.activatedRoute.params.subscribe(function (params) {
              _this7.globalService.getData1('add_form/getIncidentFormByID/' + params['incident_id']).subscribe(function (result) {
                console.log('result', result);

                if (result && result['data'] && result['data'][0]) {
                  _this7.incidentDetails = result['data'][0]; //------------------------------------------------------- incidentForm ----------------------------------------------------------//

                  _this7.incidentForm.patchValue(_this7.incidentDetails);

                  _this7.onInput('', 'Incident'); //------------------------------------------------------- incidentForm ----------------------------------------------------------//
                  //------------------------------------------------------- PhotographyForm ----------------------------------------------------------//


                  _this7.photoGraphyObject = _this7.photoGraphy = _this7.incidentDetails.photography_image; //------------------------------------------------------- PhotographyForm ----------------------------------------------------------//
                  //------------------------------------------------------- incidentDesForm ----------------------------------------------------------//

                  _this7.incidentDesForm.patchValue(_this7.incidentDetails);

                  _this7.alcohalImagesObject = _this7.alcohalImages = _this7.incidentDetails.alcohol_test_image;
                  _this7.drugTestImagesObject = _this7.drugTestImages = _this7.incidentDetails.drug_test_image;
                  _this7.alterDutyImagesObject = _this7.alterDutyImages = _this7.incidentDetails.return_to_alternate_duties_image;

                  _this7.onInput('', 'Incident Description'); //------------------------------------------------------- incidentDesForm ----------------------------------------------------------//
                  //------------------------------------------------------- classificationForm ----------------------------------------------------------//


                  var classificationValue = _this7.classificationForm.get('classification_value');

                  _this7.selectedTabList = _this7.incidentDetails['classification_value'].split(',');

                  _this7.classificationList.forEach(function (element) {
                    _this7.selectedTabList.find(function (ele) {
                      if (element.val == ele) {
                  ...
                  _this7.managerList = _this7.incidentDetails.classification_manager;

                  _this7.classificationForm.controls['date_of_incident'].setValue(_this7.incidentDetails.date_of_incident);

                  _this7.classificationForm.controls['time_of_incident'].setValue(_this7.incidentDetails.time_of_incident);

                  _this7.classificationForm.controls['date_reported'].setValue(_this7.incidentDetails.date_reported);

                  _this7.classificationForm.controls['time_reported'].setValue(_this7.incidentDetails.time_reported);

                  _this7.classificationForm.controls['classification_location_option'].setValue(_this7.incidentDetails.classification_location_option);

                  if (_this7.incidentDetails.classification_location_option == 'Add Location') _this7.classificationForm.controls['classification_location_value'].setValue(_this7.incidentDetails.classification_location_value);
                  if (_this7.incidentDetails.classification_location_option == 'Choose Location') _this7.classificationForm.controls['classification_location_value1'].setValue(_this7.incidentDetails.classification_location_value);

                  _this7.classificationForm.controls['classification_shift_type'].setValue(_this7.incidentDetails.classification_shift_type);

                  _this7.classificationForm.controls['classification_supervisor'].setValue(_this7.incidentDetails.classification_supervisor);

                  _this7.classificationForm.controls['classification_manager'].setValue(_this7.incidentDetails.classification_manager); //------------------------------------------------------- classificationForm ----------------------------------------------------------//
                  //------------------------------------------------------- assetDescriptionForm ----------------------------------------------------------//


                  _this7.assetDescriptionForm.patchValue(_this7.incidentDetails);

                  _this7.damageImagesObject = _this7.damageImages = _this7.incidentDetails.extent_damage_image; //------------------------------------------------------- assetDescriptionForm ----------------------------------------------------------//
                  //------------------------------------------------------- enviornmentForm ----------------------------------------------------------//

                  _this7.enviornmentForm.patchValue(_this7.incidentDetails);

                  if (_this7.incidentDetails.chemical_details.chemical_photo.length > 0) {
                    _this7.enviornmentForm.controls.chemical_details.value.insertPhotoCheckBox.setValue(true);
                  }

                  _this7.chemicalImages = _this7.chemicalImagesObject = _this7.incidentDetails.chemical_details.chemical_photo; //------------------------------------------------------- enviornmentForm ----------------------------------------------------------//
                  //------------------------------------------------------- injuryForm ----------------------------------------------------------//

                  _this7.injuryForm.controls.injury_persons.setValue(_this7.incidentDetails.injury_persons);

                  if (_this7.incidentDetails.person_details.length > 0) {
                    _this7.injuryForm.setControl('person_details', _this7.setPersonDetails(_this7.incidentDetails.person_details));
                  } //------------------------------------------------------- injuryForm ----------------------------------------------------------//
                  //------------------------------------------------------- reportForm ----------------------------------------------------------//


                  _this7.reportForm.patchValue(_this7.incidentDetails); //------------------------------------------------------- reportForm ----------------------------------------------------------//
                  //------------------------------------------------------- reputationDesForm ----------------------------------------------------------//


                  var reputation_option = _this7.incidentDetails['reputation_option'].split(',');

                  var reputationOption = _this7.reputationDesForm.get('reputation_option');

                  _this7.reputationCheckBox.forEach(function (element) {
                  ...
                  _this7.reputationDesForm.controls['individual_damage_value'].setValue(_this7.incidentDetails.individual_damage_value);

                  _this7.reputationDesForm.controls['company_damage_value'].setValue(_this7.incidentDetails.company_damage_value);

                  _this7.reputationDesForm.controls['reputation_negative_effect'].setValue(_this7.incidentDetails.reputation_negative_effect);

                  var effected_department = _this7.incidentDetails['effected_department'].split(',');

                  var effectedDepartment = _this7.reputationDesForm.get('effected_department');

                  _this7.departmentEffect.forEach(function (element) {
                  ...
                  _this7.reputationDesForm.controls['external_party'].setValue(_this7.incidentDetails.external_party);

                  _this7.reputationDesForm.controls['name_of_witness'].setValue(_this7.incidentDetails.name_of_witness);

                  _this7.reputationDesForm.controls['other_witness_details'].setValue(_this7.incidentDetails.other_witness_details);

                  _this7.reputationDesForm.controls['possible_outcome_incident'].setValue(_this7.incidentDetails.possible_outcome_incident); //------------------------------------------------------- reputationDesForm ----------------------------------------------------------//
                  //------------------------------------------------------- securityForm ----------------------------------------------------------//


                  _this7.securityForm.controls['security_option'].setValue(_this7.incidentDetails.security_option); // this.securityForm.controls['it_option_value'].setValue(this.incidentDetails.it_option_value);


                  _this7.securityForm.controls['what_has_been_stolen_item'].setValue(_this7.incidentDetails.what_has_been_stolen_item);

                  _this7.securityForm.controls['approximate_value_of_stolen'].setValue(_this7.incidentDetails.approximate_value_of_stolen);

                  _this7.securityForm.controls['what_is_the_specific_securities_incident'].setValue(_this7.incidentDetails.what_is_the_specific_securities_incident);

                  var it_option_value = _this7.incidentDetails.it_option_value.split(',');

                  var itOptionValue = _this7.securityForm.get('it_option_value');

                  _this7.itSecurityList.forEach(function (ele) {
          ...
          value: function setPersonDetails(person_details) {
            ...
            person_details.forEach(function (element) {
              formArray.push(_this8.fb.group({
                injured_person_option: [element.injured_person_option],
                injured_person_option_value: [element.injured_person_option_value],
            ...
            if (type == 1) {// let data = this.mobileUploadImages();
              ...
              for (var i = 0; i < event.target.files.length; i++) {
                this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  ...
                  if (_this9.photoGraphy.length <= 0) {
                    _this9.photoGraphy.push(data);
                  } else {
                    _this9.photoGraphy.unshift(data);
                  }
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this10.alcohalImages.length <= 0) {
                  _this10.alcohalImages.push(data);
                } else {
                  _this10.alcohalImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
          ...
          value: function onDrugTestImage(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this11.drugTestImages.length <= 0) {
                  _this11.drugTestImages.push(data);
                } else {
                  _this11.drugTestImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
          ...
          value: function onReturnToDutyImage(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this12.alterDutyImages.length <= 0) {
                  _this12.alterDutyImages.push(data);
                } else {
                  _this12.alterDutyImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
          ...
          value: function onSelectDamageImage(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this13.damageImages.length <= 0) {
                  _this13.damageImages.push(data);
                } else {
                  _this13.damageImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        ...
                        if ((_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.full_name) {
                          _this15.managerList = res.data.full_name;

                          _this15.classificationForm.controls.classification_manager.setValue(res.data.full_name);
                        }
                      });
                      _context.next = 6;
          ...
          value: function onSubmit(val) {
            ...
            if (val == 'submit' && validation || val == 'incomplete_submit' && validation == false) {
              ...
              this.globalService.postData1(url, fd).subscribe(function (res) {
                ...
                if (res.status) {
                  _this16.globalService.presentToast(res.message);

                  _this16.nav.navigateRoot("form-list");
                } else {
                  _this16.globalService.presentToast(res.message);
          ...
          value: function onInput(evt, val) {
            ...
            this.tabList.find(function (ele) {
              if (val == 'Incident' && _this17.incidentForm.valid) {
                if (ele.val != 'Classification') {
                  ele.tabDisable = false;
                }
              } else if (val == 'Incident Description' && _this17.incidentDesForm.valid) {
                ele.tabDisable = false;
              } else {
                if (val == 'Incident Description' && _this17.incidentDesForm.invalid && ele.val == 'Classification') {
                  ele.tabDisable = true;
                  _this17.selectedTabList = [];

                  _this17.classificationForm.reset();

                  _this17.injuryForm.reset();

                  _this17.enviornmentForm.reset();

                  _this17.reputationDesForm.reset();

                  _this17.securityForm.reset();

                  _this17.assetDescriptionForm.reset();

                  _this17.reportForm.reset();
                }
              }
            });
