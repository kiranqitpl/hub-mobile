  ...
  (self["webpackChunkhub"] = self["webpackChunkhub"] || []).push([["src_app_pages_home_safety-menu_incident_incident-form_incident-form_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _IncidentFormPage = /*#__PURE__*/function () {
        //-------------------------------------------------------- JSON DATA -------------------------------------------------------//
        function IncidentFormPage(globalService, sharedService, modalController, actionSheetController, camera, fb, nav, platform) {
        ...
        _createClass(IncidentFormPage, [{
          ...
          value: function onPhotoGraphy(event, type) {
            ...
            if (type == 1) {// let data = this.mobileUploadImages();
              ...
              var _loop = function _loop(i) {
                _this8.sharedService.getBase64(event.target.files[i]).then(function (data) {
                  _this8.photoGraphyObject[i] = data;

                  if (_this8.photoGraphy.length <= 0) {
                    _this8.photoGraphy.push(data);
                  } else {
                    _this8.photoGraphy.unshift(data);
                  }
          ...
          value: function onAlochaolImage(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this9.alcohalImages.length <= 0) {
                  _this9.alcohalImages.push(data);
                } else {
                  _this9.alcohalImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this10.drugTestImages.length <= 0) {
                  _this10.drugTestImages.push(data);
                } else {
                  _this10.drugTestImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
          ...
          value: function onReturnToDutyImage(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this11.alterDutyImages.length <= 0) {
                  _this11.alterDutyImages.push(data);
                } else {
                  _this11.alterDutyImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
          ...
          value: function onChemicalImageSelect(event) {
            ...
            for (var i = 0; i < event.target.files.length; i++) {
              this.sharedService.getBase64(event.target.files[i]).then(function (data) {
                ...
                if (_this12.chemicalImages.length <= 0) {
                  _this12.chemicalImages.push(data);
                } else {
                  _this12.chemicalImages.unshift(data);
                }
              })["catch"](function (error) {
                console.log('error', error);
              });
                    ...
                    case 3:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          _this14.incidentForm.controls['incident_near_miss'].setValue(res.data.full_name);

                          console.log('incidentForm 1', _this14.incidentForm.controls);
                          console.log('incidentForm 1', _this14.incidentForm.controls['incident_near_miss']);
                          console.log('person_details 1', _this14.injuryForm.controls['person_details']);
                          _this14.incident_near_miss = res.data;
                        }
                      });
                      _context.next = 7;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          _this15.incidentDesForm.controls['was_there_any_witness_of_the_incident'].setValue(res.data.full_name);

                          _this15.was_there_any_witness_of_the_incident = res.data;
                        }
                      });
                      _context2.next = 7;
                      return modal.present();
                  ...
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 6:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          if (headerName == 'Supervisor List') {
                            _this16.classificationForm.controls['classification_supervisor'].setValue(res.data.full_name);

                            _this16.classification_supervisor = res.data;
                          } else if (headerName == 'Manager List') {
                            _this16.classificationForm.controls['classification_manager'].setValue(res.data.full_name);

                            _this16.classification_manager = res.data;
                          }
                        }
                      });
                      _context3.next = 10;
                      ...
                      modal.onDidDismiss().then(function (res) {
                        ...
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          ...
                          if (field == 'Injured person') {
                            ...
                            console.log('first');
                            _this17.injuryPersonDetails.controls[index].value['injured_person_option'] = res.data.full_name;
                            _this17.injuryPersonDetails.controls[index].value['injured_person_option_id'] = res.data.employee_id; // this.injuryPersonDetails.controls[index]['injured_person_option'] = res.data.full_name;
                          ...
                          if (field == 'Injured administered') {
                            console.log('first 1');
                            _this17.injuryPersonDetails.controls[index].value['immediate_treatment_person_name'] = res.data.full_name;
                            _this17.injuryPersonDetails.controls[index].value['immediate_treatment_person_name_id'] = res.data.employee_id;
                          }

                          console.log('injuryPersonDetails', _this17.injuryPersonDetails);
                        }
                      });
                      _context4.next = 6;
                      return modal.present();
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 2:
                      ...
                      modal.onDidDismiss().then(function (res) {
                        if (res && (res === null || res === void 0 ? void 0 : res.data)) {
                          _this18.reputationDesForm.controls['name_of_witness'].setValue(res.data.full_name);

                          _this18.name_of_witness = res.data;
                          console.log(' this.name_of_witness', _this18.name_of_witness);
                          console.log(' this.name_of_witness', _this18.name_of_witness.employee_id);
                        }
                      });
                      _context5.next = 6;
                      return modal.present();
          ...
          value: function onSubmit(val) {
            ...
            if (val == 'submit' && validation || val == 'incomplete_submit' && validation == false) {
              ...
              fd.append('user_id', userDetails.id); // let url = (val == 'submit' ? "add_form/submit" : 'Add_form/submit_incomplete');
          ...
          value: function onInput(evt, val) {
            ...
            this.tabList.find(function (ele) {
              if (val == 'Incident' && _this19.incidentForm.valid) {
                if (ele.val != 'Classification') {
                  ele.tabDisable = false;
                }
              } else if (val == 'Incident Description' && _this19.incidentDesForm.valid) {
                ele.tabDisable = false;
              } else {
                if (val == 'Incident Description' && _this19.incidentDesForm.invalid && ele.val == 'Classification') {
                  ele.tabDisable = true;
                  _this19.selectedTabList = [];

                  _this19.classificationForm.reset();

                  _this19.injuryForm.reset();

                  _this19.enviornmentForm.reset();

                  _this19.reputationDesForm.reset();

                  _this19.securityForm.reset();

                  _this19.assetDescriptionForm.reset();

                  _this19.reportForm.reset();
                }
              }
            });
          ...
          value: function onAdministeredPerson(event, index) {
            ...
            this.employeeList.filter(function (ele) {
              if (ele.employee_id == event.detail.value) {
                console.log('ele', ele);
                _this20.injuryForm.controls['person_details'].value[index]['immediate_treatment_person_number'] = ele.emp_mobile ? ele.emp_mobile : ele.emp_work_email; // this.injuryForm.value['person_details'].controls[index]['immediate_treatment_person_number'].setValue(ele.emp_mobile ? ele.emp_mobile : ele.emp_work_email);
              }
            });
